(function(c){"object"===typeof exports&&"undefined"!==typeof module?module.exports=c(require("jquery"),require("pnotify")):"function"===typeof define&&define.amd?define("pnotify.reference",["jquery","pnotify"],c):c(jQuery,PNotify)})(function(c, d){d.prototype.options.reference={putThing:!1,labels:{text:"Spin Around"}};d.prototype.modules.reference={thingElem:null,init:function(b, a){var d=this;this.notice;this.options;a.putThing&&(this.thingElem=c('<button style="float:right;" class="btn btn-default" type="button" disabled><i class="'+
...
a+"deg)",filter:"progid:DXImageTransform.Microsoft.BasicImage(rotation="+a/360*4+")"})},20)}))},update:function(b,a,c){this.notice;this.options;a.putThing&&this.thingElem?this.thingElem.show():!a.putThing&&this.thingElem&&this.thingElem.hide();this.thingElem&&this.thingElem.find("i").attr("class",b.styles.athing)},beforeOpen:function(b,a){},afterOpen:function(b,a){},beforeClose:function(b,a){},afterClose:function(b,a){},beforeDestroy:function(b,a){},afterDestroy:function(b,a){}};c.extend(d.styling.jqueryui,
{athing:"ui-icon ui-icon-refresh"});c.extend(d.styling.bootstrap2,{athing:"icon-refresh"});c.extend(d.styling.bootstrap3,{athing:"glyphicon glyphicon-refresh"});c.extend(d.styling.fontawesome,{athing:"fa fa-refresh"})});
